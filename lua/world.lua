...
function World:update(dt)
	...
	--profiler:profile('executing timed events', function()
			self:executeTimedEvents()
		--end) -- profile

	--profiler:profile('saving actors', function()				
	...
	--profiler:profile('receiving loaded actors', function()			
	...
	--profiler:profile('updating lighting', function()
	...
	--profiler:profile('permanently removing actors', function()			
	...
	--profiler:profile('updating AI', function()
	...
	--profiler:profile('updating floating texts', function()		
	...
	--profiler:profile('updating actors', function()		
			for _, a in pairs(self._visibleActors) do
				a:update(dt)
			end
		--end) -- profile
	...
	--profiler:profile('updating collision buckets', function()			
			for _, a in pairs(self._visibleActors) do
	...
	--profiler:profile('testing collisions', function()				
			for _, a in pairs(self._visibleActors) do
	...
	--profiler:profile('generating list of visible items', function()				
			for k, _ in pairs(self._visibleIds) do
				for _, v in pairs(self._map._buckets[k]) do
